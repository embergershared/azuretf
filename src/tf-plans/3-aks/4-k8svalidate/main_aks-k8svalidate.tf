...
#
# Folder/File   : /tf-plans/3-aks/4-k8svalidate/main_aks-k8sinfra.tf
# Terraform     : 0.13.+
# Providers     : azurerm 2.+
# Plugins       : none
# Modules       : none
...
# Notes:
#     Debug a Helm chart:
#     helm install --debug --dry-run aks-demo-secret-inj ../validate/akv2k8s-injecttestapp --namespace akv2k8s-test --set akvsResourceName=k8s-validate-demo-secret-inj
...
locals {
  # Plan Tag value
  tf_plan   = "/tf-plans/3-aks/4-k8svalidate/main_aks-k8svalidate.tf"
