...
resource azurerm_monitor_diagnostic_setting vgws_diag {
  ...
  storage_account_id          = data.azurerm_resources.vgws_resources.resources[count.index].location == var.mainloc_stacct.location ? var.mainloc_stacct.id : var.secondloc_stacct.id
