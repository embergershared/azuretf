...
> This approach is used in my current project. It presents 2 main issues:    
  ...
  2. If an element is removed of the iteration, Terraform will reorder the keys and Destroy/Recreate the entire array of resources. It ended up deleting Prod resources ... to recreate them identically, just because the key in Terraform dictionary was not managed.
